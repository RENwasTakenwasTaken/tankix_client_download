...
patoolib.extract_archive(r'TankiX_Client_Installer/TankiXOld.rar', outdir=install_dir)
...
patoolib.extract_archive(r'TankiX_Client_Installer/Tanki X NEW.zip', outdir=install_dir)
